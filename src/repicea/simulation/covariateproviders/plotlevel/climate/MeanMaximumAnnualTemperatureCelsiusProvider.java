 ...
 */
public interface MeanMaximumAnnualTemperatureCelsiusProvider extends REpiceaClimateVariableProvider {

	/**
	 * Provide the mean maximum annual temperature.
	 ...
	 * @return the temperature (&deg;C)
	 */
	public default double getMeanMaximumAnnualTemperatureCelsius(ClimateSensitivePredictor predictor, Resolution resolution) {
		return getMeanMaximumAnnualTemperatureCelsius(REpiceaClimateVariableProvider.getInformationFromPredictor(predictor, 
				MeanMaximumAnnualTemperatureCelsiusProvider.class,
				resolution));
	}
