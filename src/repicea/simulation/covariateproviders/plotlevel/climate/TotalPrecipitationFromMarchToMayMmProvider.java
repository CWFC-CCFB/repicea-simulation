 ...
 * from March to May.
 * @author Mathieu Fortin - Februry 2026
 */
public interface TotalPrecipitationFromMarchToMayMmProvider extends REpiceaClimateVariableProvider {
	 ...
	 * @return a double
	 */
	public double getTotalPrecipitationFromMarchToMayMm(REpiceaClimateVariableInformation info);
	 ...
	 */
	public default double getTotalPrecipitationFromMarchToMayMm(ClimateSensitivePredictor predictor, Resolution resolution) {
		return getTotalPrecipitationFromMarchToMayMm(REpiceaClimateVariableProvider.getInformationFromPredictor(predictor, 
				TotalPrecipitationFromMarchToMayMmProvider.class,
				resolution));
	}
