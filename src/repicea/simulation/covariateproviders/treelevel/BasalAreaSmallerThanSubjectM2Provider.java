 ...
 */
public interface BasalAreaSmallerThanSubjectM2Provider {
	 ...
	 * minus tree basal area (m2/ha), the latter only affected by the area-related expansion factor 
	 * and not the number of trees in the tree instance.
